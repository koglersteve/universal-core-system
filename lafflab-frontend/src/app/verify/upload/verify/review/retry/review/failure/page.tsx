...
export default function VerifyUploadVerifyReviewRetryReviewFailurePage() {
  return (
    <div className="min-h-screen flex items-center justify-center p-6 text-center text-white">
      <div className="space-y-6">
        ...
        <h1 className="text-3xl font-bold">Final Review Failed</h1>
        <p className="text-gray-300">
          Your corrected documents did not pass the final verification review. Please fix the issues and try again.
        </p>
